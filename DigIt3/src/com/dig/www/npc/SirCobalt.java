...
public class SirCobalt extends BlockerNPC {
	...
	public SirCobalt(int x, int y, String loc, Board owner, String location, boolean canBe) {
		super(x, y, loc, owner, new String[] { "So you're here to fight Drusk? Seems like we have a common goal...",
