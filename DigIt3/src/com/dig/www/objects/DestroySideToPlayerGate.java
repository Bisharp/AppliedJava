...
public class DestroySideToPlayerGate extends Gate{

	public DestroySideToPlayerGate(int x, int y, String loc, boolean wall, Board owner) {
		super(x, y, loc, wall, owner);
